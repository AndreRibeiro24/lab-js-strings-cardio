...
newString = string2[2] + string2[11] + string2[11] + string2[10];
...
console.log(fruit.slice(fruit.indexOf(favoriteFruit),fruit.indexOf(favoriteFruit) + favoriteFruit.length));
